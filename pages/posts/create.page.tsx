            ...
            <div className="mt-10">
              <div className="my-4">
                ...
                <input
                  ...
                  {...register('title', { 
                    ...
                    minLength: { value: 1, message: '1글자 이상 입력해주셔야합니다' },
                    maxLength: { value: 100, message: '100자 미만으로 작성해주셔야합니다' }
                  })}
                />
              ...
              <div className="my-4">
                ...
                <textarea
                  ...
                  {...register('body', { 
                    required: "필수 입력 사항입니다", 
                    minLength: { value: 10, message: '10글자 이상 입력해주셔야합니다' },
                    maxLength: { value: 1000, message: '1000자 미만으로 작성해주셔야합니다' }
                  })}
                />
